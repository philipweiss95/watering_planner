...
Zusätzlich verwaltet der Planer einen 30-l-Vorratstank mit eigener Nachfüllpumpe. Die deaktivierbare Automatik darf genau einmal täglich im festen Nachtfenster von `01:00` bis `02:00` laufen. Sie füllt die Hälfte des zu diesem Zeitpunkt im Haupttank fehlenden Wassers nach; die Menge wird auf den Rest im Vorratstank begrenzt. Ein verpasstes Nachtfenster wird tagsüber nicht nachgeholt.
