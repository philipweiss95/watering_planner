...
function plannerConfigFromForm(form, previous) {
  return {
    ...
    refill_high_reserve_threshold_percent: Number(named(form, "refill_high_reserve_threshold_percent").value),
    refill_high_reserve_minimum_transfer_ml: Math.round(Number(named(form, "refill_high_reserve_minimum_transfer_liters").value) * 1000),
...
export function renderSettings(state, evaluation, onChanged = async () => {}) {
  ...
  [
    ...
    ["refill_high_reserve_threshold_percent", Number(config.refill_high_reserve_threshold_percent || 0)],
    ["refill_high_reserve_minimum_transfer_liters", Number(config.refill_high_reserve_minimum_transfer_ml || 0) / 1000],
